...
const LearnMore = () => {
  ...
  return (
    <section className="min-h-[400px] bg-white md:min-h-[600px] w-full flex items-center md:justify-center relative px-4 md:px-6">
      <div className=" sm:max-w-[700px] w-full flex flex-col items-center gap-4 md:gap-6 relative z-10">
        <h2 className="text-black font-nb font-light text-[24px] md:text-[48px] leading-[28px] md:leading-[52px] tracking-[-0.7px] md:tracking-[-1.4px] text-center">
          Make the Leap to <br className="block lg:hidden" /> Social Mining
        </h2>
        <p className="max-w-[447px] w-full text-center text-[14px] md:text-base leading-[18px] md:leading-normal tracking-[-0.3px] md:tracking-normal">

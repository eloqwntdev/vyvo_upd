      ...
      <div className="max-w-[1280px] w-full mx-auto flex items-center justify-between">
        <div className="max-w-[530px] w-full flex items-center justify-center relative">
          ...
          >
            <Image
              ...
              width={924}
              height={1233}
              className="w-[308px] object-contain"
            />
          </motion.div>
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              BioSense™ Watch is the first VAI OS companion device, easily
              connecting you to this uniquely capable Life CoPilot. With a
              built-in microphone and speaker, you can interact with VAI OS
              right from your wrist, wherever you are.* And it can interact with
              you through natural conversations!
              <br />
              <br />
            ...
            >
              ...
              <motion.li variants={fadeInUp} className="flex items-start gap-3">
                <div className="rounded-full w-2 h-2 bg-white mt-2 shrink-0"></div>
                <span className="text-white font-nb font-light text-[16px] leading-[20px]">
                  Even more: Simply ask VAI OS how it can help you and give it
                  tasks throughout your day!
                </span>
              </motion.li>
            </motion.ul>
          </div>

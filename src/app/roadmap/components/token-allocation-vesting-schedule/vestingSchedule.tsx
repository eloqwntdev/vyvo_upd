...
const VestingSchedule = () => {
  ...
  return (
    <div className="rounded-[24px] p-4 h-full w-full bg-[rgba(83,72,215,0.04)] shadow-[inset_6px_80px_80px_0px_rgba(148,168,237,0.02),inset_0px_-1px_1px_0px_rgba(148,168,237,0.2),inset_0px_1px_1px_0px_rgba(148,168,237,0.2)] backdrop-blur-[75.8px]">
      <div className="rounded-[24px] h-full flex flex-col gap-10 p-8 border-[2px] border-[rgba(161,117,255,0.4)] backdrop-blur-[33.8px]">

  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-row gap-3 h-full w-full">
        <div className="flex flex-col-reverse gap-5 items-end text-white font-nb font-light text-[14px] leading-[18px] tracking-[-0.42px]">
        ...
        <div className="relative w-full h-[400px]">
          ...
          <div className="w-full h-full pb-1 gap-5 flex flex-row justify-between items-end">
      ...
      <div className="w-full h-fit flex pl-14 flex-wrap items-start content-start gap-y-3 gap-x-6">
        {chartdata.map((data, index) => (
          <div
            key={index}
          ...
          >
            ...
            ></div>
            <span className="text-white font-nb font-light text-[14px] leading-[18px] tracking-[-0.42px]">
              {data.label}
            </span>
          </div>
        ))}

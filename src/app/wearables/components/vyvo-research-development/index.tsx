...
const VyvoResearchDevelopment = () => {
  ...
  return (
    <section className="max-w-[1267px] w-full mx-auto px-4 md:px-6 lg:px-8 flex flex-col md:flex-row justify-between py-10 md:py-20 gap-8 md:gap-12">
      ...
      <motion.div
        ...
        animate={areImagesInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 30 }}
        transition={{ duration: 0.7, ease: "easeOut" }}
